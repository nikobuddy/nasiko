...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    move_uploaded_file($main_photo_tmp, "images/places/" . $main_photo_name);
    ...
    foreach ($_FILES["sub_photos"]["tmp_name"] as $key => $tmp_name) {
        if ($_FILES["sub_photos"]["name"][$key]) {
            ...
            move_uploaded_file($_FILES["sub_photos"]["tmp_name"][$key], "images/places/" . $sub_photo_name);
...
<body>
    ...
    <form action="submit_hotel.php" method="post" enctype="multipart/form-data">
        ...
        <label for="image">Hotel Image:</label><br>
